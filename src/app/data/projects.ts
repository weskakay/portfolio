...
export const PROJECTS: readonly Project[] = [
  ...
  },
  {
    ...
    title: 'Bestell-App',
    description: {
      de: 'Eine Bestell-App fürs Essen, in der man Restaurants durchstöbert, Gerichte in den Warenkorb legt und die Lieferung aufgibt.',
      en: 'A food ordering app where you browse restaurants, add dishes to your cart and place a delivery order.',
    },
    badges: ['JavaScript', 'HTML', 'CSS'],
    type: 'web',
    image: '/images/projects/bestellapp.png',
